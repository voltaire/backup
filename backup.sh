...
screen -p 0 -r 2036.pts-0.ichiro -X eval "stuff \"save-on\"\015"

# Wait a second for the gnu-screen to allow another stuffing and optionally alert users that the backup has been completed.
sleep 1
screen -p 0 -r 2036.pts-0.ichiro -X eval "stuff \"say Backup has been completed.\"\015"

rsync -av $backupDest/*.tar.gz backups:/home/backups/mc-voltaire-sh/backups/
